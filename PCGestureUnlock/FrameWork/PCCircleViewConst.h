 ...
 *  单个圆背景色
 */
#define CircleBackgroundColor [UIColor whiteColor]//原先透明clearColor
/**
 *  9个圆背景颜色
 */
#define Circle9ViewBackgroundColor rgba(239,239,246,1)
/**
 *  上面9个小圆背景颜色
 */
#define Circle9InfoViewBackgroundColor [UIColor lightGrayColor]

/**
 *  解锁背景色
 */
#define CircleViewBackgroundColor rgba(239,239,246,1)//239,239,246//默认的13,52,89,1

/**
 *  普通状态下外空心圆颜色
 */
#define CircleStateNormalOutsideColor [UIColor redColor]//原来颜色(241,241,241,1)
 ...
 *  普通状态下内实心圆颜色
 */
#define CircleStateNormalInsideColor rgba(255,255,255,1)//原来clearColor

/**
 *  选中状态下内实心圆颜色
 */
#define CircleStateSelectedInsideColor [UIColor yellowColor]//rgba(34,178,246,1)
